...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'editor', 'reporter'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Articles', path: '/articles', entity: 'article', service: AccessServiceEnum.PROJECT, icon: FiFileText },
    { name: 'Reports', path: '/reports', entity: 'report', service: AccessServiceEnum.PROJECT, icon: FiClipboard },
